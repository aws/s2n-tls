...
extern int s2n_config_set_cache_store_callback(struct s2n_config *config, int (*cache_store)(const void *key, uint64_t key_size, const void *value, uint64_t value_size), void *data);
extern int s2n_config_set_cache_retrieve_callback(struct s2n_config *config, int (*cache_retrieve)(const void *key, uint64_t key_size, void *value, uint64_t value_size), void *data);
