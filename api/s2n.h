...
extern int s2n_encrypt_session_cache(struct s2n_connection *conn, const uint8_t *session, uint8_t *out); 
extern int s2n_decrypt_session_cache(struct s2n_connection *conn, const uint8_t *encrypted_session, uint8_t *out); 
