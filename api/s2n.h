...
S2N_API
extern int s2n_cert_chain_and_key_load_pem_using_len(struct s2n_cert_chain_and_key *chain_and_key, char *chain_pem, uint32_t chain_len, char *private_key_pem, uint32_t private_key_len);
S2N_API
