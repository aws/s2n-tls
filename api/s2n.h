...
S2N_API
extern ssize_t s2n_client_hello_get_raw_extension_length(struct s2n_client_hello *ch, uint16_t extension_type);
S2N_API
extern ssize_t s2n_client_hello_get_raw_extension_by_id(struct s2n_client_hello *ch, uint16_t extension_type, uint8_t *out, uint32_t max_length);
S2N_API
