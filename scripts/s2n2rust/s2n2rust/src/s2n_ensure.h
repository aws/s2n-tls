...
void __STUB_POSIX_GUARD(int result);
void __STUB_POSIX_GUARD_OSSL(int result, int error);
void __STUB_POSIX_GUARD_RESULT(s2n_result result);
void __STUB_POSIX_GUARD_PTR(void* result);
...
void __STUB_RESULT_GUARD(s2n_result result);
void __STUB_RESULT_GUARD_OSSL(int result, int error);
void __STUB_RESULT_GUARD_POSIX(int result);
void __STUB_RESULT_GUARD_PTR(void* result);
...
void __STUB_PTR_GUARD(void* result);
void __STUB_PTR_GUARD_OSSL(int result, int error);
void __STUB_PTR_GUARD_POSIX(int result);
void __STUB_PTR_GUARD_RESULT(s2n_result result);
