...
#define ERR_ENTRIES(ERR_ENTRY) \
    ...
    ERR_ENTRY(S2N_ERR_INVALID_PSK_ISSUE_TIME, "The pre-shared key issue time is in the future") \
    ERR_ENTRY(S2N_ERR_SESSION_TICKET_TOO_OLD, "Session ticket is too old") \
