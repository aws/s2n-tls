...
#define ERR_ENTRIES(ERR_ENTRY) \
    ...
    ERR_ENTRY(S2N_ERR_EXTERNAL_FAILURE, "Error in external handshake functions") \
    ERR_ENTRY(S2N_ERR_EXTERNAL_CTX_STATUS_INVALID, "Unknown external handshake status") \
