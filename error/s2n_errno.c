...
#define ERR_ENTRIES(ERR_ENTRY) \
    ...
    ERR_ENTRY(S2N_ERR_P_HASH_INVALID_ALGORITHM, "invalid hmac_state algorithm") \
    ERR_ENTRY(S2N_ERR_P_HASH_INIT_FAILED, "error initializing hmac_state") \
    ERR_ENTRY(S2N_ERR_P_HASH_UPDATE_FAILED, "error updating hmac_state") \
    ERR_ENTRY(S2N_ERR_P_HASH_FINAL_FAILED, "error creating hmac_state digest") \
    ERR_ENTRY(S2N_ERR_P_HASH_WIPE_FAILED, "error wiping hmac_state") \
