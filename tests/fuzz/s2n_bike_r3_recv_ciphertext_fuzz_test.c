...
/* Target Functions: s2n_kem_recv_ciphertext s2n_kem_decapsulate BIKE_L1_R3_crypto_kem_dec */
...
#define KAT_FILE_NAME "../unit/kats/bike_r3.kat"

/* This fuzz test uses the first private key (count = 0) from tests/unit/kats/bike_r3.kat.
 ...
 * prepending BIKE_L1_R3_CIPHERTEXT_BYTES as two hex-encoded bytes. */
static struct s2n_kem_params kem_params = { .kem = &s2n_bike_l1_r3 };
