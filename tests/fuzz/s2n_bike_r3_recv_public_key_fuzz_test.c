...
/* Target Functions: s2n_kem_recv_public_key s2n_kem_encapsulate BIKE_L1_R3_crypto_kem_enc */
 ...
 * key (count = 0) from bike_r3.kat and prepending BIKE_L1_R3_PUBLIC_KEY_BYTES as two
