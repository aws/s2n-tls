...
uint32_t cert_chain_len, private_key_len;
...
int s2n_fuzz_init(int *argc, char **argv[])
{
    ...
    POSIX_GUARD(s2n_cert_chain_and_key_load_pem_using_len(default_cert, cert_chain, cert_chain_len, private_key, private_key_len));
