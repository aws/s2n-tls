...
static struct s2n_kem_keypair server_kem_keys = {.negotiated_kem = &s2n_sike_r1_p503};
...
int LLVMFuzzerInitialize(const uint8_t *buf, size_t len)
{
    ...
    server_kem_keys.private_key.size = s2n_sike_r1_p503.private_key_length;
    server_kem_keys.private_key.data = s2n_stuffer_raw_read(&private_key_stuffer, s2n_sike_r1_p503.public_key_length);
    return 0;
}
