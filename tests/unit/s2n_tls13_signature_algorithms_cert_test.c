...
/* s2n is limited to ECDSA certs when RSA_PSS certs are not supported. Since s2n doesn't choose between ECDSA
 * certs, this test is only relevant when RSA_PSS certs are supported. */
