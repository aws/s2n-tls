...
int main(int argc, char **argv)
{
    ...
    /* Test s2n_extensions_server_key_share_send_check */
    {
        ...
        EXPECT_SUCCESS(s2n_extensions_server_key_share_send_size(conn));
    ...
    /* Test s2n_extensions_server_key_share_send */
    {
        ...
        for (int i = 0; i < S2N_ECC_SUPPORTED_CURVES_COUNT; i++) {
            ...
            S2N_STUFFER_WRITTEN_EXPECT_EQUAL(extension_stuffer, s2n_ecc_supported_curves[i].share_size + 8);
