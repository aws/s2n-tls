...
int main(int argc, char **argv)
{
    ...
    /* Test Deprecated Security Policies*/
    {
        ...
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("KMS-PQ-TLS-1-0-2019-06", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        ...
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-SIKE-TEST-TLS-1-0-2020-02", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("KMS-PQ-TLS-1-0-2020-02", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-0-2020-12", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-1-2021-05-17", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-0-2021-05-18", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-0-2021-05-19", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-0-2021-05-20", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-1-2021-05-21", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-0-2021-05-22", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-0-2021-05-23", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_find_security_policy_from_version("PQ-TLS-1-0-2021-05-25", &security_policy), S2N_ERR_DEPRECATED_SECURITY_POLICY);

        /* Add list length check so that when new policies are deprecated, they are added to this test. */
        EXPECT_EQUAL(deprecrated_security_policies_len, 14);
    }
    ...
    }
    {
        ...
        EXPECT_FAILURE_WITH_ERRNO(s2n_config_set_cipher_preferences(config, "KMS-PQ-TLS-1-0-2020-07"), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_config_set_cipher_preferences(config, "KMS-PQ-TLS-1-0-2020-02"), S2N_ERR_DEPRECATED_SECURITY_POLICY);
        EXPECT_FAILURE_WITH_ERRNO(s2n_config_set_cipher_preferences(config, "KMS-PQ-TLS-1-0-2019-06"), S2N_ERR_DEPRECATED_SECURITY_POLICY);
    ...
    {
        EXPECT_FAILURE_WITH_ERRNO(s2n_validate_kem_preferences(NULL), S2N_ERR_NULL);
        EXPECT_SUCCESS(s2n_validate_kem_preferences(&kem_preferences_null));
        ...
        for (size_t i = 0; i < s2n_array_len(invalid_kem_prefs); i++) {
            EXPECT_FAILURE_WITH_ERRNO(s2n_validate_kem_preferences(&invalid_kem_prefs[i]), S2N_ERR_INVALID_SECURITY_POLICY);
        }
