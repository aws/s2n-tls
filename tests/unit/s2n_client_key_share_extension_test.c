...
/* Test s2n_extensions_client_key_share_recv */
{
    ...
    /* Test that s2n_extensions_client_key_share_recv errors on key share size longer than data */
    {
        ...
        EXPECT_SUCCESS(s2n_write_key_share(
            &key_share_extension,
            s2n_ecc_supported_curves[0]->iana_id,
            s2n_ecc_supported_curves[0]->share_size * 10,
            s2n_ecc_supported_curves[0]));
    ...
    /* Test that s2n_extensions_client_key_share_recv ignores unsupported curves */
    {
        ...
        EXPECT_SUCCESS(s2n_write_key_share(
            &key_share_extension, 0, s2n_ecc_supported_curves[0]->share_size, s2n_ecc_supported_curves[0]));
        /* 0xFF01 -> obsolete_RESERVED */
        EXPECT_SUCCESS(s2n_write_key_share(
            &key_share_extension, 65281, s2n_ecc_supported_curves[0]->share_size, s2n_ecc_supported_curves[0]));
    ...
    /* Test that s2n_extensions_client_key_share_recv ignores curves with incorrect key size */
    {
        ...
        EXPECT_SUCCESS(s2n_write_key_share(
            &key_share_extension,
            s2n_ecc_supported_curves[0]->iana_id,
            s2n_ecc_supported_curves[1]->share_size,
            s2n_ecc_supported_curves[1]));
        S2N_WRITE_DATA_LENGTH(&key_share_extension);
