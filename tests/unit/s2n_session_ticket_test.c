...
int main(int argc, char **argv)
{
    ...
    /* Scenario 2: Client sends empty ST and server has multiple encrypt-decrypt keys to choose from for encrypting NST */
    {
         ...
         * encryption peak. However the algorithm will sometimes pick a key that is not at its peak encryption because the
         ...
         * working as intended.
         *
         * Here, out of 450 iterations we allow the test to fail (1 / 450) = 0.2% of the time. This is a higher failure rate
