...
int main(int argc, char **argv)
{
    ...
    /* Test that negotiating TLS1.2 with QUIC-enabled client fails */
    {
        ...
        EXPECT_SUCCESS(s2n_config_set_cipher_preferences(quic_config, test_all_policy_name));
        ...
        EXPECT_SUCCESS(s2n_config_set_cipher_preferences(non_quic_config, test_all_policy_name));
