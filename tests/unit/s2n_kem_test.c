...
}
{
    ...
    kem_extension_size kem_extensions[] = { TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R1, TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R2,
                                            TLS_PQ_KEM_EXTENSION_ID_SIKE_P503_R1,
                                            TLS_PQ_KEM_EXTENSION_ID_SIKE_P434_R2 };
...
}
{
    ...
    EXPECT_FAILURE_WITH_ERRNO(s2n_get_kem_from_extension_id(non_existant_kem_id, &returned_kem),
                              S2N_ERR_KEM_UNSUPPORTED_PARAMS);
}
