...
int check_drgb_version(
    s2n_drbg_mode mode,
    int (*generator)(struct s2n_blob *),
...
int main(int argc, char **argv) {
    ...
    EXPECT_SUCCESS(check_drgb_version(
        S2N_AES_128_CTR_NO_DF_PR,
        &nist_fake_128_urandom_data,
        32,
    ...
    EXPECT_SUCCESS(check_drgb_version(
        ...
        &nist_fake_256_urandom_data,
        48,
        nist_aes256_reference_personalization_strings_hex,
        nist_aes256_reference_values_hex,
    ...
    EXPECT_SUCCESS(s2n_stuffer_alloc_ro_from_hex_string(
        &nist_aes256_no_pr_reference_entropy, nist_aes256_no_pr_reference_entropy_hex));
    EXPECT_SUCCESS(check_drgb_version(
        S2N_DANGEROUS_AES_256_CTR_NO_DF_NO_PR,
        &nist_fake_256_no_pr_urandom_data,
        48,
