...
{
    unsigned char pub_key[SIKE_P503_PUBLIC_KEY_BYTES] = {0};
    unsigned char priv_key[SIKE_P503_SECRET_KEY_BYTES] = {0};
    unsigned char c_shared_secret[SIKE_P503_SHARED_SECRET_BYTES];
    unsigned char s_shared_secret[SIKE_P503_SHARED_SECRET_BYTES];
    unsigned char ciphertext[SIKE_P503_CIPHERTEXT_BYTES];
