...
#define S2N_MAX_TEST_PEM_PATH 512
 ...
 * @param type indicates `rsa`, `rsapss`, or `ecdsa` cert
 * @param size indicates an rsa/rsapss cert of `2048`, `3072`, or `4096` or an
 * ecdsa cert with `p256`, `p384`, or `p521`.
