...
const uint64_t p434x4[NWORDS64_FIELD]            = { 0xFFFFFFFFFFFFFFFC, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
...
const uint64_t A_gen[6*NWORDS64_FIELD]           = { 0x05ADF455C5C345BF, 0x91935C5CC767AC2B, 0xAFE4E879951F0257,
...
const uint64_t B_gen[6*NWORDS64_FIELD]           = { 0x6E5497556EDD48A3, 0x2A61B501546F1C05, 0xEB919446D049887D,
