...
#define PQCLEAN_KYBER512_CLEAN_kyber_shake128_absorb S2N_KYBER_512_R3_NAMESPACE(_PQCLEAN_KYBER512_CLEAN_kyber_shake128_absorb)
void PQCLEAN_KYBER512_CLEAN_kyber_shake128_absorb(keccak_state *s, const uint8_t *input, uint8_t x, uint8_t y);

#define PQCLEAN_KYBER512_CLEAN_kyber_shake128_squeezeblocks S2N_KYBER_512_R3_NAMESPACE(_PQCLEAN_KYBER512_CLEAN_kyber_shake128_squeezeblocks)
void PQCLEAN_KYBER512_CLEAN_kyber_shake128_squeezeblocks(uint8_t *output, size_t nblocks, keccak_state *s);

#define PQCLEAN_KYBER512_CLEAN_shake256_prf S2N_KYBER_512_R3_NAMESPACE(_PQCLEAN_KYBER512_CLEAN_shake256_prf)
