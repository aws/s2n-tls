...
void poly_tomsg_avx2(uint8_t msg[S2N_KYBER_512_R3_INDCPA_MSGBYTES], poly *a);
...
#define poly_getnoise_eta1_4x S2N_KYBER_512_R3_NAMESPACE(poly_getnoise_eta1_4x)
...
#define poly_nttunpack S2N_KYBER_512_R3_NAMESPACE(poly_nttunpack)
