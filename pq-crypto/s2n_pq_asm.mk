...
ifndef S2N_NO_PQ_ASM
    ...
    KYBER512R3_AVX2_SUPPORTED := $(shell $(CC) -mavx2 -mbmi2 -c -o $(dummy_file_out) $(dummy_file) > /dev/null 2>&1; echo $$?; rm $(dummy_file_out) > /dev/null 2>&1)
    ifeq ($(KYBER512R3_AVX2_SUPPORTED), 0)
        CFLAGS += -DS2N_KYBER512R3_AVX2
        CFLAGS_LLVM += -DS2N_KYBER512R3_AVX2
        KYBER512R3_AVX2_FLAGS := -mavx2 -mbmi2
    endif
endif
