...
static const uint64_t p434[NWORDS64_FIELD] = {
        0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFDC1767AE2FFFFFF, 0x7BC65C783158AEA3,
        0x6CFC5FD681C52056, 0x0002341F27177344
};
static const uint64_t p434p1[NWORDS64_FIELD] = {
        0x0000000000000000, 0x0000000000000000, 0x0000000000000000, 0xFDC1767AE3000000, 0x7BC65C783158AEA3,
        0x6CFC5FD681C52056, 0x0002341F27177344
};
static const uint64_t p434x2[NWORDS64_FIELD] = {
        0xFFFFFFFFFFFFFFFE, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFB82ECF5C5FFFFFF, 0xF78CB8F062B15D47,
        0xD9F8BFAD038A40AC, 0x0004683E4E2EE688
};
// Alice's generator values {XPA0 + XPA1*i, XQA0 + xQA1*i, XRA0 + XRA1*i} in GF(p434^2), expressed in Montgomery representation
static const uint64_t A_gen[6 * NWORDS64_FIELD] = {
...
static const uint64_t B_gen[6 * NWORDS64_FIELD] = {
...
static const uint64_t Montgomery_R2[NWORDS64_FIELD] = {
        0x28E55B65DCD69B30, 0xACEC7367768798C2, 0xAB27973F8311688D, 0x175CC6AF8D6C7C0B, 0xABCD92BF2DDE347E,
        0x69E16A61C7686D9A, 0x000025A89BCDD12A
};
// Value one in Montgomery representation
static const uint64_t Montgomery_one[NWORDS64_FIELD] = {
        0x000000000000742C, 0x0000000000000000, 0x0000000000000000, 0xB90FF404FC000000,0xD801A4FB559FACD4,
...
static const unsigned int strat_Alice[MAX_Alice - 1] = {
        ...
        2, 1, 1, 2, 1, 1, 3, 2, 1, 1, 1, 1, 5, 4, 2, 1, 1, 2, 1, 1, 2, 1, 1, 1, 21, 12, 7, 4, 2, 1, 1, 2, 1, 1, 3, 2, 1,
        1, 1, 1, 5, 3, 2, 1, 1, 1, 1, 2, 1, 1, 1, 9, 5, 3, 2, 1, 1, 1, 1, 2, 1, 1, 1, 4, 2, 1, 1, 1, 2, 1, 1
};
...
static const unsigned int strat_Bob[MAX_Bob - 1] = {
        ...
        16, 8, 4, 3, 1, 1, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1, 8, 4, 2, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1, 16, 8, 4, 2,
        1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1, 8, 4, 2, 1, 1, 2, 1, 1, 4, 2, 1, 1, 2, 1, 1
};

#if defined(GENERIC_IMPLEMENTATION)
#include "sike_p434_r2_fp_generic.c"
#else
#include "sike_p434_r2_fp_x64.c"
// #include "sike_p434_r2_fp_x64_asm.S" TODO include this
#endif

#include "sike_p434_r2_fpx.c"
#include "sike_p434_r2_ec_isogeny.c"
#include "sike_p434_r2_sidh.c"
