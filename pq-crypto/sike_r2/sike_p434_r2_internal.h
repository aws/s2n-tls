...
#ifndef SIKE_P434_R2_INTERNAL_H
#define SIKE_P434_R2_INTERNAL_H

#include "sike_p434_r2_config.h"
...
typedef digit_t dfelm_t[
        2 * NWORDS_FIELD]; // Datatype for representing double-precision 2x434-bit field elements (448-bit max.)
...
void mp_add_asm_434r2(const digit_t *a, const digit_t *b, digit_t *c);
...
void mp_subaddx2_asm_434r2(const digit_t *a, const digit_t *b, digit_t *c);

void mp_subaddx2_asm_434r2(const digit_t *a, const digit_t *b, digit_t *c);

// Double 2x434-bit multiprecision subtraction, c = c-a-b, where c > a and c > b
void mp_dblsubx2_asm_434r2(const digit_t *a, const digit_t *b, digit_t *c);

// Multiprecision right shift by one
void mp_shiftr1_434r2(digit_t *x, const unsigned int nwords);

// Digit multiplication, digit * digit -> 2-digit result
void digit_x_digit_434r2(const digit_t a, const digit_t b, digit_t *c);

// Multiprecision comba multiply, c = a*b, where lng(a) = lng(b) = nwords.
void mp_mul_434r2(const digit_t *a, const digit_t *b, digit_t *c, const unsigned int nwords);

/************ Field arithmetic functions *************/

// Copy of a field element, c = a
void fpcopy_434r2(const felm_t a, felm_t c);

// Zeroing a field element, a = 0
void fpzero_434r2(felm_t a);

// Modular addition, c = a+b mod p434
extern void fpadd_434r2(const digit_t *a, const digit_t *b, digit_t *c);

extern void fpadd_asm_434r2(const digit_t *a, const digit_t *b, digit_t *c);

// Modular subtraction, c = a-b mod p434
extern void fpsub_434r2(const digit_t *a, const digit_t *b, digit_t *c);

extern void fpsub_asm_434r2(const digit_t *a, const digit_t *b, digit_t *c);

// Modular negation, a = -a mod p434
extern void fpneg_434r2(digit_t *a);

// Modular division by two, c = a/2 mod p434.
void fpdiv2_434r2(const digit_t *a, digit_t *c);

// Modular correction to reduce field element a in [0, 2*p434-1] to [0, p434-1].
void fpcorrection_434r2(digit_t *a);

// 434-bit Montgomery reduction, c = a mod p
void rdc_mont_434r2(const digit_t *a, digit_t *c);

// Field multiplication using Montgomery arithmetic, c = a*b*R^-1 mod p434, where R=2^768
void fpmul_mont_434r2(const digit_t *a, const digit_t *b, digit_t *c);

void mul_asm_434r2(const digit_t *a, const digit_t *b, digit_t *c);

void rdc_asm_434r2(const digit_t *ma, digit_t *mc);

// Field squaring using Montgomery arithmetic, c = a*b*R^-1 mod p434, where R=2^768
void fpsqr_mont_434r2(const digit_t *ma, digit_t *mc);
...
void fpinv_mont_434r2(digit_t *a);

// Chain to compute (p434-3)/4 using Montgomery arithmetic
void fpinv_chain_mont_434r2(digit_t *a);
...
extern void fp2add_434r2(const f2elm_t *a, const f2elm_t *b, f2elm_t *c);

// GF(p434^2) subtraction, c = a-b in GF(p434^2)
extern void fp2sub_434r2(const f2elm_t *a, const f2elm_t *b, f2elm_t *c);
