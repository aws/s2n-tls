...
#include "sike_p434_r2__internal.h"

__inline void fpadd_434r2(const digit_t *a, const digit_t *b, digit_t *c) {
    ...
    fpadd_asm_434r2(a, b, c);

#endif
}

__inline void fpsub_434r2(const digit_t *a, const digit_t *b, digit_t *c) {
    ...
    fpsub_asm_434r2(a, b, c);

#endif
}

__inline void fpneg_434r2(digit_t *a) {
...
void fpdiv2_434r2(const digit_t *a, digit_t *c) {
    ...
    mp_shiftr1_434r2(c, NWORDS_FIELD);
}
...
void rdc_mont_434r2(const digit_t *ma, digit_t *mc) {
