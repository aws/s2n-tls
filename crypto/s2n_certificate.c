...
int s2n_cert_chain_and_key_set_cert_chain_using_len(struct s2n_cert_chain_and_key *cert_and_key, char *cert_chain_pem, uint32_t cert_chain_len)
{
    struct s2n_stuffer chain_in_stuffer = { 0 };

    POSIX_GUARD(s2n_stuffer_init_ro_from_string(&chain_in_stuffer, (uint8_t *)cert_chain_pem, cert_chain_len));
...
int s2n_cert_chain_and_key_set_private_key_using_len(struct s2n_cert_chain_and_key *cert_and_key, char *private_key_pem, uint32_t private_key_len)
{
    ...
    POSIX_GUARD(s2n_stuffer_init_ro_from_string(&key_in_stuffer, (uint8_t *)private_key_pem, private_key_len));
...
int s2n_cert_chain_and_key_load_pem_using_len(struct s2n_cert_chain_and_key *chain_and_key, char *chain_pem,
                                              uint32_t chain_len, char *private_key_pem, uint32_t private_key_len)
{
    POSIX_ENSURE_REF(chain_and_key);

    POSIX_GUARD(s2n_cert_chain_and_key_set_cert_chain_using_len(chain_and_key, chain_pem, chain_len));
    POSIX_GUARD(s2n_cert_chain_and_key_set_private_key_using_len(chain_and_key, private_key_pem, private_key_len));
