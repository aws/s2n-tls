        ...
        struct s2n_stuffer *extension)
{
    ...
    POSIX_ENSURE(s2n_kem_preferences_includes_tls13_kem_group(kem_pref, named_group_iana),
    ...
    POSIX_ENSURE(received_total_share_size == server_kem_group_params->kem_group->server_share_size,
            S2N_ERR_BAD_KEY_SHARE);
    ...
    POSIX_ENSURE(s2n_ecc_evp_read_params_point(extension, ecc_share_size, &point_blob) == S2N_SUCCESS,
            S2N_ERR_BAD_KEY_SHARE);
        ...
        struct s2n_stuffer *extension)
{
    ...
    POSIX_ENSURE(client_ecc_evp_params->negotiated_curve == server_ecc_evp_params->negotiated_curve,
            S2N_ERR_BAD_KEY_SHARE);
