...
struct s2n_kex {
    ...
    int (*connection_supported_and_configure)(const struct s2n_cipher_suite *cipher_suite, struct s2n_connection *conn);
...
extern int s2n_kex_supported_and_configure(const struct s2n_cipher_suite *cipher_suite, struct s2n_connection *conn);
