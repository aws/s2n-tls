...
struct s2n_kex {
    ...
    int (*connection_supported)(const struct s2n_kex *kex, const struct s2n_connection *conn);
...
extern int s2n_kex_supported(const struct s2n_kex *kex, const struct s2n_connection *conn);
