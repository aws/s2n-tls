...
struct s2n_kex {
    ...
    int (*server_key_external)(struct s2n_connection *conn, struct s2n_blob *data_to_sign);
    int (*client_key_external)(struct s2n_connection *conn, struct s2n_blob *shared_key);
