...
struct {
    ...
    { "default", &cipher_preferences_20170210, 0, 0},
    { "default_fips", &cipher_preferences_20170405, 0, 0},
    { "ELBSecurityPolicy-TLS-1-0-2015-04", &elb_security_policy_2015_04, 0, 0},
    /* Not a mistake. TLS-1-0-2015-05 and 2016-08 are equivalent */
    { "ELBSecurityPolicy-TLS-1-0-2015-05", &elb_security_policy_2016_08, 0, 0},
    { "ELBSecurityPolicy-2016-08", &elb_security_policy_2016_08, 0, 0},
    { "ELBSecurityPolicy-TLS-1-1-2017-01", &elb_security_policy_tls_1_1_2017_01, 0, 0},
    { "ELBSecurityPolicy-TLS-1-2-2017-01", &elb_security_policy_tls_1_2_2017_01, 0, 0},
    { "ELBSecurityPolicy-TLS-1-2-Ext-2018-06", &elb_security_policy_tls_1_2_ext_2018_06, 0, 0},
    { "ELBSecurityPolicy-FS-2018-06", &elb_security_policy_fs_2018_06, 0, 0},
    { "CloudFront-Upstream", &cipher_preferences_cloudfront_upstream, 0, 0},
    { "CloudFront-SSL-v-3", &cipher_preferences_cloudfront_ssl_v_3, 0, 0},
    { "CloudFront-TLS-1-0-2014", &cipher_preferences_cloudfront_tls_1_0_2014, 0, 0},
    { "CloudFront-TLS-1-0-2016", &cipher_preferences_cloudfront_tls_1_0_2016, 0, 0},
    { "CloudFront-TLS-1-1-2016", &cipher_preferences_cloudfront_tls_1_1_2016, 0, 0},
    { "CloudFront-TLS-1-2-2018", &cipher_preferences_cloudfront_tls_1_2_2018, 0, 0},
    { "CloudFront-TLS-1-2-2019", &cipher_preferences_cloudfront_tls_1_2_2019, 0, 0},
    { "KMS-TLS-1-0-2018-10", &cipher_preferences_kms_tls_1_0_2018_10, 0, 0},
    { "KMS-PQ-TLS-1-0-2019-06", &cipher_preferences_kms_pq_tls_1_0_2019_06, 0, 0},
    { "KMS-FIPS-TLS-1-2-2018-10", &cipher_preferences_kms_fips_tls_1_2_2018_10, 0, 0},
    { "20140601", &cipher_preferences_20140601, 0, 0},
    { "20141001", &cipher_preferences_20141001, 0, 0},
    { "20150202", &cipher_preferences_20150202, 0, 0},
    { "20150214", &cipher_preferences_20150214, 0, 0},
    { "20150306", &cipher_preferences_20150306, 0, 0},
    { "20160411", &cipher_preferences_20160411, 0, 0},
    { "20160804", &cipher_preferences_20160804, 0, 0},
    { "20160824", &cipher_preferences_20160824, 0, 0},
    { "20170210", &cipher_preferences_20170210, 0, 0},
    { "20170328", &cipher_preferences_20170328, 0, 0},
    { "20190214", &cipher_preferences_20190214, 0, 0},
    { "20170405", &cipher_preferences_20170405, 0, 0},
    { "20170718", &cipher_preferences_20170718, 0, 0},
    { "20190120", &cipher_preferences_20190120, 0, 0},
    { "20190121", &cipher_preferences_20190121, 0, 0},
    { "20190122", &cipher_preferences_20190122, 0, 0},
    { "test_all", &cipher_preferences_test_all, 0, 0},
    { "test_all_fips", &cipher_preferences_test_all_fips, 0, 0},
    { "test_all_ecdsa", &cipher_preferences_test_all_ecdsa, 0, 0},
    { "test_ecdsa_priority", &cipher_preferences_test_ecdsa_priority, 0, 0},
    { "null", &cipher_preferences_null, 0, 0},
    { NULL, NULL, 0, 0}
};
