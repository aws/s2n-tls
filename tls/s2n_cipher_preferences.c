...
struct {
    ...
    { .version="test_tls13_null_key_exchange_alg_cipher_preferences", .preferences=&cipher_preferences_test_tls13_null_key_exchange_alg, .ecc_extension_required=0, .pq_kem_extension_required=0},
