...
struct s2n_cipher_suite s2n_all_cipher_suites[] = {
    {"RC4-MD5", {TLS_RSA_WITH_RC4_128_MD5}, &s2n_rsa, &s2n_rc4, S2N_HMAC_MD5, S2N_SSLv3},   /* 0x00,0x04 */
    {"RC4-SHA", {TLS_RSA_WITH_RC4_128_SHA}, &s2n_rsa, &s2n_rc4, S2N_HMAC_SHA1, S2N_SSLv3},  /* 0x00,0x05 */
    {"DES-CBC3-SHA", {TLS_RSA_WITH_3DES_EDE_CBC_SHA}, &s2n_rsa, &s2n_3des, S2N_HMAC_SHA1, S2N_TLS10},   /* 0x00,0x0A */
    {"EDH-RSA-DES-CBC3-SHA", {TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA}, &s2n_dhe, &s2n_3des, S2N_HMAC_SHA1, S2N_TLS10},   /* 0x00,0x16 */
    {"AES128-SHA", {TLS_RSA_WITH_AES_128_CBC_SHA}, &s2n_rsa, &s2n_aes128, S2N_HMAC_SHA1, S2N_TLS10},   /* 0x00,0x2F */
    {"DHE-RSA-AES128-SHA", {TLS_DHE_RSA_WITH_AES_128_CBC_SHA}, &s2n_dhe, &s2n_aes128, S2N_HMAC_SHA1, S2N_TLS10},   /* 0x00,0x33 */
    {"AES256-SHA", {TLS_RSA_WITH_AES_256_CBC_SHA}, &s2n_rsa, &s2n_aes256, S2N_HMAC_SHA1, S2N_TLS10},   /* 0x00,0x35 */
    {"DHE-RSA-AES256-SHA", {TLS_DHE_RSA_WITH_AES_256_CBC_SHA}, &s2n_dhe, &s2n_aes256, S2N_HMAC_SHA1, S2N_TLS10},   /* 0x00,0x39 */
    {"AES128-SHA256", {TLS_RSA_WITH_AES_128_CBC_SHA256}, &s2n_rsa, &s2n_aes128, S2N_HMAC_SHA256, S2N_TLS12},   /* 0x00,0x3C */
    {"AES256-SHA256", {TLS_RSA_WITH_AES_256_CBC_SHA256}, &s2n_rsa, &s2n_aes256, S2N_HMAC_SHA256, S2N_TLS12},   /* 0x00,0x3D */
    {"DHE-RSA-AES128-SHA256", {TLS_DHE_RSA_WITH_AES_128_CBC_SHA256}, &s2n_dhe, &s2n_aes128, S2N_HMAC_SHA256, S2N_TLS12},   /* 0x00,0x67 */
    {"DHE-RSA-AES256-SHA256", {TLS_DHE_RSA_WITH_AES_256_CBC_SHA256}, &s2n_dhe, &s2n_aes256, S2N_HMAC_SHA256, S2N_TLS12},   /* 0x00,0x6B */
    {"AES128-GCM-SHA256", {TLS_RSA_WITH_AES_128_GCM_SHA256}, &s2n_rsa, &s2n_aes128_gcm, S2N_HMAC_NONE, S2N_TLS12},   /* 0x00,0x9C */
    {"DHE-RSA-AES128-GCM-SHA256", {TLS_DHE_RSA_WITH_AES_128_GCM_SHA256}, &s2n_dhe, &s2n_aes128_gcm, S2N_HMAC_NONE, S2N_TLS12},   /* 0x00,0x9E */
    {"ECDHE-RSA-DES-CBC3-SHA", {TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA}, &s2n_ecdhe, &s2n_3des, S2N_HMAC_SHA1, S2N_TLS10},   /* 0xC0,0x12 */
    {"ECDHE-RSA-AES128-SHA", {TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA}, &s2n_ecdhe, &s2n_aes128, S2N_HMAC_SHA1, S2N_TLS10},   /* 0xC0,0x13 */
    {"ECDHE-RSA-AES256-SHA", {TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA}, &s2n_ecdhe, &s2n_aes256, S2N_HMAC_SHA1, S2N_TLS10},   /* 0xC0,0x14 */
    {"ECDHE-RSA-AES128-SHA256", {TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256}, &s2n_ecdhe, &s2n_aes128, S2N_HMAC_SHA256, S2N_TLS12},   /* 0xC0,0x27 */
    {"ECDHE-RSA-AES256-SHA384", {TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384}, &s2n_ecdhe, &s2n_aes256, S2N_HMAC_SHA384, S2N_TLS12},   /* 0xC0,0x28 */
    {"ECDHE-RSA-AES128-GCM-SHA256", {TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256}, &s2n_ecdhe, &s2n_aes128_gcm, S2N_HMAC_NONE, S2N_TLS12},   /* 0xC0,0x2F */
    {"ECDHE-RSA-AES256-GCM-SHA384", {TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384}, &s2n_ecdhe, &s2n_aes256_gcm, S2N_HMAC_NONE, S2N_TLS12},   /* 0xC0,0x30 */
};
