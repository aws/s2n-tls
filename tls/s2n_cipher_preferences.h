...
#define S2N_BIKE_EXTENSION_ENABLED 0x02
#define S2N_SIKE_EXTENSION_ENABLED 0x04
...
extern int s2n_bike_enabled(const struct s2n_cipher_preferences *preferences);
extern int s2n_sike_enabled(const struct s2n_cipher_preferences *preferences);
