...
const struct s2n_kex s2n_rsa = {
        ...
        .server_key_external = NULL,
        .client_key_external = &s2n_rsa_client_key_external,
...
const struct s2n_kex s2n_dhe = {
        ...
        .server_key_external = &s2n_dhe_server_key_external,
        .client_key_external = &s2n_dhe_client_key_external,
...
const struct s2n_kex s2n_ecdhe = {
        ...
        .server_key_external = &s2n_ecdhe_server_key_external,
        .client_key_external = &s2n_ecdhe_client_key_external,
...
int s2n_kex_server_key_external(const struct s2n_kex *kex, struct s2n_connection *conn, struct s2n_blob *data_to_sign)
{
    notnull_check(kex->server_key_external);
    return kex->server_key_external(conn, data_to_sign);
}

int s2n_kex_client_key_external(const struct s2n_kex *kex, struct s2n_connection *conn, struct s2n_blob *shared_key)
{
    notnull_check(kex->client_key_external);
    return kex->client_key_external(conn, shared_key);
}
