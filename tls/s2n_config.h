...
typedef enum {
    ...
    S2N_DEFAULT_POLICY = 0,

    /* Use the "default_fips" security policy */
    S2N_DEFAULT_FIPS_POLICY,

    /* Support overriding the security policies in tests */
    S2N_TESTING_OVERRIDE_POLICY_TLS12,
    S2N_TESTING_OVERRIDE_POLICY_TLS12_FIPS,
    S2N_TESTING_OVERRIDE_POLICY_TLS13,
} s2n_default_security_policy;
