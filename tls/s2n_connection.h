...
struct s2n_connection {
    ...
    /* The number of bytes to send before changing the record size. If this value > 0 then dynamic TLS record size is enabled. Otherwise, the feature is disabled (default). */
