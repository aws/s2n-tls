...
int accept_all_rsa_certs(uint8_t *cert_chain_in, uint32_t cert_chain_len, s2n_cert_type *cert_type, s2n_cert_public_key *public_key_out, void *context);
int deny_all_certs(uint8_t *cert_chain_in, uint32_t cert_chain_len, s2n_cert_type *cert_type, s2n_cert_public_key *public_key_out, void *context);
