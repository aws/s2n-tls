...
int s2n_validate_kem_preferences(const struct s2n_kem_preferences *kem_preferences, bool pq_kem_extension_required)
{
    ...
    uint32_t count = 0;
    POSIX_ENSURE(s2n_result_is_ok(s2n_kem_preferences_groups_available(kem_preferences, &count)), S2N_ERR_INVALID_STATE);
    POSIX_ENSURE(count == avail_count, S2N_ERR_INVALID_STATE);
