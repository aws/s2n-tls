...
const struct s2n_security_policy security_policy_cloudfront_tls_1_0_2020 = {
    .minimum_protocol_version = S2N_TLS10,
    .cipher_preferences = &cipher_preferences_cloudfront_tls_1_0_2020,
    .kem_preferences = &kem_preferences_null,
    .signature_preferences = &s2n_signature_preferences_20200207,
    .ecc_preferences = &s2n_ecc_preferences_20200310,
};
...
struct s2n_security_policy_selection security_policy_selection[] = {
    ...
    { .version="CloudFront-TLS-1-0-2020", .security_policy=&security_policy_cloudfront_tls_1_0_2020, .ecc_extension_required=0, .pq_kem_extension_required=0 },
