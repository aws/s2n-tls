...
/* TODO The round 3 extension values are temporary placeholders until the draft spec (draft-campagna-tls-bike-sike-hybrid) gets updated */
#define TLS_PQ_KEM_EXTENSION_ID_KYBER_512_R3 25
