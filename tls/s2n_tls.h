...
extern S2N_RESULT s2n_tls13_server_nst_send(struct s2n_connection *conn, s2n_blocked_status *blocked);
extern int s2n_tls13_server_nst_write(struct s2n_connection *conn, struct s2n_stuffer *output);
