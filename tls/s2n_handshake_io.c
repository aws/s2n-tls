...
static struct s2n_handshake_action state_machine[] = {
    ...
    [TLS12_ENCRYPTED_EXTENSIONS] = {TLS_HANDSHAKE, TLS_NPN, 'C', {s2n_tls12_encrypted_extensions_recv, s2n_tls12_encrypted_extensions_send}},
...
static const char *message_names[] = {
    ...
    MESSAGE_NAME_ENTRY(TLS12_ENCRYPTED_EXTENSIONS),
};
...
static message_type_t handshakes[S2N_HANDSHAKES_COUNT][S2N_MAX_HANDSHAKE_LENGTH] = {
    ...
    [NEGOTIATED | WITH_NPN ] = {
            CLIENT_HELLO,
            SERVER_HELLO, SERVER_CHANGE_CIPHER_SPEC, SERVER_FINISHED,
            CLIENT_CHANGE_CIPHER_SPEC, TLS12_ENCRYPTED_EXTENSIONS, CLIENT_FINISHED,
            APPLICATION_DATA
    },
    ...
    [NEGOTIATED | FULL_HANDSHAKE | WITH_NPN ] = {
            CLIENT_HELLO,
            SERVER_HELLO, SERVER_CERT, SERVER_HELLO_DONE,
            CLIENT_KEY, CLIENT_CHANGE_CIPHER_SPEC, TLS12_ENCRYPTED_EXTENSIONS, CLIENT_FINISHED,
            SERVER_CHANGE_CIPHER_SPEC, SERVER_FINISHED,
            APPLICATION_DATA
    },
    ...
    [NEGOTIATED | FULL_HANDSHAKE | CLIENT_AUTH| WITH_NPN ] = {
            CLIENT_HELLO,
            SERVER_HELLO, SERVER_CERT, SERVER_CERT_REQ, SERVER_HELLO_DONE,
            CLIENT_CERT, CLIENT_KEY, CLIENT_CERT_VERIFY, CLIENT_CHANGE_CIPHER_SPEC, TLS12_ENCRYPTED_EXTENSIONS, CLIENT_FINISHED,
            SERVER_CHANGE_CIPHER_SPEC, SERVER_FINISHED,
            APPLICATION_DATA
    },
    ...
    [NEGOTIATED | FULL_HANDSHAKE | CLIENT_AUTH | NO_CLIENT_CERT | WITH_NPN ] = {
            CLIENT_HELLO,
            SERVER_HELLO, SERVER_CERT, SERVER_CERT_REQ, SERVER_HELLO_DONE,
            CLIENT_CERT, CLIENT_KEY, CLIENT_CHANGE_CIPHER_SPEC, TLS12_ENCRYPTED_EXTENSIONS, CLIENT_FINISHED,
            SERVER_CHANGE_CIPHER_SPEC, SERVER_FINISHED,
            APPLICATION_DATA
    },
