...
#define S2N_TLS12_TICKET_SIZE_IN_BYTES (1 + S2N_TICKET_KEY_NAME_LEN + S2N_TICKET_INFO_SIZE \
        + S2N_TLS_GCM_IV_LEN + S2N_TLS12_STATE_SIZE_IN_BYTES + S2N_TLS_GCM_TAG_LEN)
