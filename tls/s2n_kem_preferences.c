...
const struct s2n_kem_group *pq_kem_groups_ietf_2024_08[] = {
    &s2n_secp256r1_mlkem_768,
    &s2n_x25519_mlkem_768,
};

/* Includes both Kyber and ML-KEM KEMs. */
const struct s2n_kem_group *pq_kem_groups_mixed_2024_08[] = {
    &s2n_secp256r1_mlkem_768,
    &s2n_x25519_mlkem_768,
    &s2n_secp256r1_kyber_768_r3,
    &s2n_x25519_kyber_768_r3,
...
/* Includes only the IETF standard KEM groups. */
const struct s2n_kem_preferences kem_preferences_pq_tls_1_3_2024_08 = {
    .kem_count = 0,
    .kems = NULL,
    .tls13_kem_group_count = s2n_array_len(pq_kem_groups_ietf_2024_08),
    .tls13_kem_groups = pq_kem_groups_ietf_2024_08,
    .tls13_pq_hybrid_draft_revision = 10
};

/* Includes both IETF standard and draft KEM groups for compatibility. */
const struct s2n_kem_preferences kem_preferences_pq_mixed_tls_1_3_2024_08 = {
    .kem_count = 0,
    .kems = NULL,
    .tls13_kem_group_count = s2n_array_len(pq_kem_groups_mixed_2024_08),
    .tls13_kem_groups = pq_kem_groups_mixed_2024_08,
    .tls13_pq_hybrid_draft_revision = 10
};
