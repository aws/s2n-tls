...
extern int s2n_set_signature_hash_pair_from_preference_list(struct s2n_connection *conn, struct s2n_map *sig_hash_algs, s2n_hash_algorithm *hash, s2n_signature_algorithm *sig);
