...
extern int s2n_set_signature_hash_pair_from_preference_list(struct s2n_connection *conn, struct s2n_sig_scheme_list *sig_hash_algs,
...
extern int s2n_recv_supported_signature_algorithms(struct s2n_connection *conn, struct s2n_stuffer *in, struct s2n_sig_scheme_list *sig_hash_algs);
